...
SECRET_KEY = 'django-insecure-m#kdryt0j@%1^p6a6r-b1n)spil$-)3@t!u4uv$e+3_w%x651v'
...
#         'NAME': 'agrotech',  # Database name you want to use in XAMPP
